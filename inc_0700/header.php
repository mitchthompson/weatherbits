...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="https://www.mitchlthompson.com/weatherbits/css/styles.css" type="text/css">
        ...
        <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js"></script>
          ...
          <script src="https://www.mitchlthompson.com/weatherbits/js/script.js"></script> 
    </head>
        <body>
            ...
            <div class="container-fluid">
                ...
                <div class="navbar-collapse collaspe collapse"  id="myNav">                               
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="/weatherbits/user/user-lg.php">Log In</a></li>    
                    </ul> 
