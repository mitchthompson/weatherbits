...
define('PREFIX', 'wbit_'); #Prefix to add uniqueness to DB table names.  Limits hackability, naming collisions
...
include INCLUDE_PATH . 'credentials_inc.php'; # Stores DB credentials 
include INCLUDE_PATH . 'common_inc.php'; # Provides common utility functions 
